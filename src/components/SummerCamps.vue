  ...
  <div class="camp-landing">
    ...
    <section class="hero">
      ...
      <div class="hero__content">
        <div class="hero__eyebrow">Summer 2026 Camp</div>
        <h1 class="hero__headline">
          <span class="hero__headline--stroke">ELEVATE</span>
          <span class="hero__headline--solid">YOUR GAME</span>
        </h1>
        <p class="hero__sub">
          Elite coaching · Real reps · Next-level players.<br />
          For ages 7–17 in Everett, WA.
        </p>
    ...
    <section id="schedule" class="section section--dark">
      <div class="container">
        ...
        <p class="section__sub">Two sessions. One goal: get better every single day.</p>
    ...
    <section id="pricing" class="section section--light">
      <div class="container">
        <h2 class="section__title">Pricing & <span class="accent">Packages</span></h2>
        <p class="section__sub">Transparent pricing. No hidden fees. Sibling discounts available.</p>
        ...
        <form class="reg-form" @submit.prevent="handleSubmit" novalidate>
          <div class="reg-form__row">
            <div class="form-group" :class="{ 'form-group--error': errors.parentName }">
              ...
              <input id="parentName" v-model="form.parentName" type="text" placeholder="Jane Smith" />
            ...
            <div class="form-group" :class="{ 'form-group--error': errors.email }">
              ...
              <input id="email" v-model="form.email" type="email" placeholder="jane@email.com" />
          ...
          <div class="reg-form__row">
            <div class="form-group" :class="{ 'form-group--error': errors.playerName }">
              ...
              <input id="playerName" v-model="form.playerName" type="text" placeholder="Alex Smith" />
            ...
            <div class="form-group" :class="{ 'form-group--error': errors.age }">
              ...
              <input id="age" v-model="form.age" type="number" min="8" max="18" placeholder="12" />
          ...
          <div class="form-group">
            ...
            <textarea id="notes" v-model="form.notes" rows="3" placeholder="Allergies, skill level, questions…"></textarea>
          </div>

          <div v-if="submitSuccess" class="reg-form__success">
            🎉 You're on the list! We'll be in touch at {{ form.email }} shortly.
          </div>
...
const sessions = ref([
  {
    ...
    days: ['Mon–Fri', '9:00 AM – 12:00 PM', 'Challenger Elementary Gym'],
    ages: '8–12',
    featured: false,
  },
  {
    id: 'session-b',
    week: 'Session B',
    name: 'Elite Development Camp',
    dates: 'July 14 – July 18',
    days: ['Mon–Fri', '9:00 AM – 3:00 PM', 'Challenger Elementary Gym'],
    ages: '13–18',
    featured: true,
  },
])
...
const plans = ref([
  ...
  },
  {
    ...
    features: [
      ...
      'Recruiting profile review (14–18)',
    ],
  },
])
